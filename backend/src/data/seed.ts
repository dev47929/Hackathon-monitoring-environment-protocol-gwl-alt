import type { Team, ActivityLog, HackathonStats } from '../types/index.js';
...
const initialTeams: Team[] = [
  {
    ...
    commits: [
      {
        hash: 'f5d83a1', timestamp: '2026-07-04T09:15:00-07:00', author: 'Alex Rivera',
        ...
        aiSummary: 'Bootstrapped the backend skeleton. Initialized Express server with typescript config and environment setups.',
      ...
      {
        hash: 'a2b3c4d', timestamp: '2026-07-04T11:30:00-07:00', author: 'Sarah Chen',
        ...
        additions: 185, deletions: 0,
        aiSummary: 'Authored the initial core smart contract. Implements rider deposit escrow and state variables for rides.',
        featureEvolution: 'Introduced on-chain ride lifecycle state machine.',
        category: 'blockchain',
      ...
      {
        hash: 'c8d9e0f', timestamp: '2026-07-04T14:45:00-07:00', author: 'Marcus Johnson',
        ...
        additions: 310, deletions: 12,
        aiSummary: 'Designed rider dashboard and integrated Mapbox container with destination/price/driver panels.',
      ...
      {
        hash: 'e4f5a6b', timestamp: '2026-07-04T18:20:00-07:00', author: 'Sarah Chen',
        ...
        additions: 155, deletions: 22,
        aiSummary: 'Added custom staking mechanisms for drivers and signature-based rating manipulation prevention.',
      ...
      {
        hash: 'b1c2d3e', timestamp: '2026-07-04T22:10:00-07:00', author: 'Alex Rivera',
        ...
        additions: 98, deletions: 5,
        aiSummary: 'Implemented database configs for ride histories, driver metadata, and auth session caching with retries.',
      ...
      {
        hash: '7a8b9c0', timestamp: '2026-07-05T01:30:00-07:00', author: 'Marcus Johnson',
        ...
        additions: 240, deletions: 15,
        aiSummary: 'Integrated MetaMask/Web3 wallet login flow with chain-id tracking and disconnect toasts.',
        ...
        blockchainStatus: 'verified', riskScore: 11, justificationStatus: 'none',
      },
      {
        hash: '4d3e2f1', timestamp: '2026-07-05T04:15:00-07:00', author: 'Alex Rivera',
        message: 'Write Express backend endpoints linking React and Solidity',
        changedFiles: ['server/routes/ride.ts', 'server.ts'],
        additions: 190, deletions: 8,
        aiSummary: 'Wrote API proxy listeners querying smart contract event logs and auto-updating the status cache.',
        featureEvolution: 'Bridged middleware connecting Web3 contract events and off-chain caching.',
        category: 'backend',
      ...
      {
        hash: '0e9d8c7', timestamp: '2026-07-05T05:00:00-07:00', author: 'Marcus Johnson',
        message: 'Finalize matching dashboard & polishing CSS animations',
        changedFiles: ['src/components/RiderDashboard.tsx', 'src/index.css'],
        additions: 115, deletions: 4,
        aiSummary: 'Designed smooth driver-search micro-animations, polished layouts, hover effects, and responsive controls.',
    ...
    commits: [
      {
        ...
        blockchainStatus: 'verified', riskScore: 4, justificationStatus: 'none',
      },
      {
        hash: 'ca91e23', timestamp: '2026-07-04T12:00:00-07:00', author: 'Dmitri Volkov',
        ...
        additions: 120, deletions: 2,
        aiSummary: 'Implemented Express server bridging to Gemini API to process images of household objects and determine CO2 offsets.',
        ...
        blockchainStatus: 'verified', riskScore: 12, justificationStatus: 'none',
      },
      {
        hash: '9f8e7d6', timestamp: '2026-07-04T17:40:00-07:00', author: 'Dmitri Volkov',
        ...
        additions: 15400, deletions: 0,
        aiSummary: 'Flagged: Massive code/binary upload. Committed 15.4k lines containing serialized pre-trained weight coordinates for local edge classification.',
        ...
        blockchainStatus: 'verified', isSuspicious: true,
      ...
      {
        hash: 'b2d8e4f', timestamp: '2026-07-05T00:15:00-07:00', author: 'Chloe Smith',
  ...
  },
  {
    ...
    commits: [
      {
        hash: 'b1a9988', timestamp: '2026-07-04T10:00:00-07:00', author: 'James Zhao',
      ...
      {
        hash: 'force-push-99', timestamp: '2026-07-04T18:30:00-07:00', author: 'James Zhao',
        ...
        blockchainStatus: 'failed', isSuspicious: true,
      ...
      {
        hash: 'd3f5e92', timestamp: '2026-07-05T03:00:00-07:00', author: 'James Zhao',
        ...
        riskScore: 89, justificationStatus: 'pending',
      },
    ],
    claimedFeatures: [
  ...
  },
  {
    ...
    commits: [
      {
        hash: 'c1b2a3d', timestamp: '2026-07-04T09:00:00-07:00', author: 'Liam Murphy',
        message: 'Initial workspace setups',
        changedFiles: ['package.json', 'src/App.tsx'],
        additions: 55, deletions: 0,
        ...
        blockchainStatus: 'verified', riskScore: 3, justificationStatus: 'none',
      },
      {
        hash: 'b2c9e83', timestamp: '2026-07-04T13:10:00-07:00', author: 'Nisha Patel',
        message: 'Integrate Web3 connection models',
        changedFiles: ['src/components/ConnectWallet.tsx', 'src/utils/web3-provider.js'],
        additions: 4320, deletions: 12,
        aiSummary: 'WARNING: Potential code clone detected. Contains 4,300 additions closely matching 98% of a public web3-react boiler template.',
      ...
      {
        hash: '9a8d7c6', timestamp: '2026-07-04T20:30:00-07:00', author: 'Liam Murphy',
        ...
        additions: 290, deletions: 15,
        aiSummary: 'Implemented custom hooks calling Web3 endpoints. Safely handles balance lookups, formats balances, and displays them.',
  ...
  },
  {
    ...
    commits: [
      ...
      {
        hash: 'c3d4a01', timestamp: '2026-07-04T11:00:00-07:00', author: 'Alice Thorne',
      ...
      {
        hash: 'e5f6b21', timestamp: '2026-07-04T15:30:00-07:00', author: 'Charlie Green',
        message: 'Create Express auditor proxy invoking Gemini API and AST parsing',
        changedFiles: ['server/auditor.ts', 'server.ts'],
        additions: 340, deletions: 12,
        aiSummary: 'Implemented backend parser that strips solidity files into ASTs and feeds them to Gemini model along with security templates.',
      ...
      },
      {
        ...
        additions: 430, deletions: 8,
        aiSummary: 'Created panels to paste Solidity files, displaying reentrancy visual alerts with interactive highlights mapping to lines.',
      ...
      {
        hash: '2f3e4d5', timestamp: '2026-07-05T02:00:00-07:00', author: 'Alice Thorne',
        ...
        additions: 110, deletions: 4,
        aiSummary: 'Refined AI instruction parameters to map vulnerabilities to precise column/line index blocks to prevent false alerts.',
...
export const seedTeams = (): Team[] => JSON.parse(JSON.stringify(initialTeams));
export const seedActivityLogs = (): ActivityLog[] => JSON.parse(JSON.stringify(initialActivityLogs));

export function computeStats(teams: Team[]): HackathonStats {
